...
function steamGraph(csvpath, color) {
  if(color == "blue") {
...
*/
        ...
        //pro = d.values[invertedx].value;

        var selected = data.filter(data => data.Year === invertedx.toString() && data.key ===$(this).attr('id') );
